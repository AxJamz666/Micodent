...
5. Push y PR hacia integracion; vincular issue, riesgos y reversion.
6. CI correcto y aceptacion del propietario. Preferir merge commit para
...
La solicitud del propietario de hacer commit/push en cada trabajo autorizado
queda en AGENTS.md. No autoriza nuevas fases ni fusiones automaticas a main.
